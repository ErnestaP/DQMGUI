...
export const getSize = (state: any): string => pathOr('', ['DATA', 'PLOTS','PLOTS_INFO', 'SIZES', 'size'], state);
export const getAdditionalPlotsSize = (state: any): string => pathOr('', ['DATA', 'PLOTS','PLOTS_INFO', 'SIZES', 'additionalSize'], state);
